...
public class HelloController {
	...
	//@GET
	@RequestMapping(value = "/pnr" , method=RequestMethod.GET , produces="application/json") //we want to send the pnrdetails in the json form
	public List<Train> getPNRDetails(){
